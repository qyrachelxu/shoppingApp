...
import com.beaconfire.housingservice.exception.InvalidCredentialsException;
...
public class JwtProvider {
    ...
    public Optional<AuthUserDetail> resolveToken(HttpServletRequest request)  {
        ...
        if(request.getRequestURI().equals("/housing-service/swagger-ui.html") ||
                request.getRequestURI().startsWith("/housing-service/webjars") ||
                request.getRequestURI().startsWith("/housing-service/v2") ||
                request.getRequestURI().startsWith("/housing-service/csrf") ||
                request.getRequestURI().startsWith("/housing-service/swagger-resources")){
