...
public class JwtProvider {
    ...
    public Optional<AuthUserDetail> resolveToken(HttpServletRequest request) throws AuthenticationException  {
        ...
        if(request.getRequestURI().equals("/composite-service/swagger-ui.html") ||
                request.getRequestURI().startsWith("/composite-service/webjars") ||
                request.getRequestURI().startsWith("/composite-service/v2") ||
                request.getRequestURI().startsWith("/composite-service/csrf") ||
                request.getRequestURI().startsWith("/composite-service/swagger-resources")){
